...
DEFINE_GUID (VioScsiExtendedInfoGuid_GUID, 0x5cdac4f6, 0x3d46, 0x44e2, 0x8d,
             0xee, 0x01, 0x60, 0x6e, 0x11, 0xe2, 0x65);
#endif
...
#define VioScsiExtendedInfo_SIZE                                              \
  (FIELD_OFFSET (VioScsiExtendedInfo, ResponseTime)                           \
   + VioScsiExtendedInfo_ResponseTime_SIZE)
