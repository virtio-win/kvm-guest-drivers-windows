...
class CGuestAnnouncePacketHolder : public CRefCountingObject,
                                   public CNdisAllocatable<CGuestAnnouncePacketHolder, 'NBLH'>
{
  private:
...
class CGuestAnnouncePackets : public CPlacementAllocatable
{
  ...
  public:
    ...
    enum
    {
        cloneFlags = NDIS_CLONE_FLAGS_USE_ORIGINAL_MDLS
    };
