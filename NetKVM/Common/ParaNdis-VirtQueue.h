...
class CTXDescriptor : public CNdisAllocatable<CTXDescriptor, 'DTHR'>
{
  public:
    ...
    bool Create(NDIS_HANDLE DrvHandle, ULONG VirtioHeaderSize, struct VirtIOBufferDescriptor *VirtioSGL,
                ULONG VirtioSGLSize, bool Indirect, bool AnyLayout)
    {
...
class CVirtQueue
{
  public:
    ...
    int AddBuf(struct VirtIOBufferDescriptor sg[], unsigned int out_num, unsigned int in_num, void *data,
...
class CTXVirtQueue : public CVirtQueue
{
  public:
    ...
    bool Create(UINT Index, VirtIODevice *IODevice, NDIS_HANDLE DrvHandle, ULONG MaxBuffers, ULONG HeaderSize,
