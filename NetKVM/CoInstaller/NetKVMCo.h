...
typedef DWORD(WINAPI NS_CONTEXT_DUMP_FN)(IN LPCWSTR pwszRouter, _In_reads_(dwArgCount) LPWSTR *ppwcArguments,
                                         _In_ DWORD dwArgCount, IN LPCVOID pvData);
...
typedef DWORD(WINAPI FN_HANDLE_CMD)(IN LPCWSTR pwszMachine, _Inout_updates_(dwArgCount) LPWSTR *ppwcArguments,
                                    IN DWORD dwCurrentIndex, IN DWORD dwArgCount, IN DWORD dwFlags, IN LPCVOID pvData,
                                    OUT BOOL *pbDone);
