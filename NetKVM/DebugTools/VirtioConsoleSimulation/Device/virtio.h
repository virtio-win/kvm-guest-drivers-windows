...
typedef struct VirtIODevice
{
    ...
    int nvectors;
    uint32_t (*get_features)(struct VirtIODevice *vdev, uint32_t requested_features);
    uint32_t (*bad_features)(struct VirtIODevice *vdev);
    void (*set_features)(struct VirtIODevice *vdev, uint32_t val);
    void (*get_config)(struct VirtIODevice *vdev, uint8_t *config);
    void (*set_config)(struct VirtIODevice *vdev, const uint8_t *config);
    void (*reset)(struct VirtIODevice *vdev);
    void (*set_status)(struct VirtIODevice *vdev, uint8_t val);
    VirtQueue *vq;
