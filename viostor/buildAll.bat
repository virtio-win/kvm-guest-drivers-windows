...
:WNET_32
call :buildpack Wnet x86 "Win2k3 Release|x86" buildfre_wnet_x86.log
goto :eof

:WNET_64
call :buildpack Wnet x64 "Win2k3 Release|x64" buildfre_wnet_amd64.log
goto :eof

:WXP_32
call :buildpack Wxp x86 "WinXP Release|x86" buildfre_wxp_x86.log
goto :eof
