...
BOOL
WriteTest (__in CDevice *pDev, __in BOOLEAN ovrl)
{
  PUCHAR buf = NULL;
  BOOLEAN res = TRUE;
  int i;
...
BOOL
WriteTestCycl (__in CDevice *pDev, __in BOOLEAN ovrl)
{
  int ch;
  for (;;)
    {
...
BOOL
ReadTest (__in CDevice *pDev, __in BOOLEAN ovrl)
{
  PUCHAR buf = NULL;
  BOOLEAN res = TRUE;
...
BOOL
ReadTestCycl (__in CDevice *pDev, __in BOOLEAN ovrl)
{
  int ch;
  for (;;)
    {
