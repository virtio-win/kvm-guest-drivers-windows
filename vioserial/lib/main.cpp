...
BOOL APIENTRY
DllMain (HANDLE hModule, ULONG ul_reason_for_call, LPVOID lpReserved)
{
...
DLL_API PVOID
OpenPortByName (const wchar_t *name)
{
  PnPControl *control = PnPControl::GetInstance ();
...
DLL_API VOID
RegisterNotification (PVOID port, VIOSERIALNOTIFYCALLBACK pfn, PVOID ptr)
{
  PnPControl *control = PnPControl::GetInstance ();
