...
DWORD __stdcall CService::HandlerExThunk (CService *service, DWORD ctlcode,
                                          DWORD evtype, PVOID evdata)
{
  switch (ctlcode)
    ...
    case SERVICE_CONTROL_HARDWAREPROFILECHANGE:
      return service->ServiceHandleDeviceChange (
          evtype, (_DEV_BROADCAST_HEADER *)evdata);
...
void __stdcall CService::ServiceMainThunk (CService *service, DWORD argc,
                                           TCHAR *argv[])
{
...
BOOL
CService::InitService ()
{
  DWORD id;

  m_thHandle = CreateThread (NULL, 0, (LPTHREAD_START_ROUTINE)ServiceThread,
                             (LPVOID)this, 0, &id);
...
DWORD WINAPI
CService::ServiceThread (LPDWORD lParam)
{
...
BOOL
CService::SendStatusToSCM (DWORD dwCurrentState, DWORD dwWin32ExitCode,
...
void
CService::terminate (DWORD error)
{
  if (m_evTerminate)
    {
...
void
CService::ServiceCtrlHandler (DWORD controlCode)
{
...
DWORD
CService::ServiceHandleDeviceChange (DWORD evtype,
...
DWORD
CService::ServiceHandlePowerEvent (DWORD evtype, DWORD flags)
{
...
void
CService::ServiceMain (DWORD argc, LPTSTR *argv)
{
  BOOL res;
...
void
CService::GetStatus (SC_HANDLE service)
{
