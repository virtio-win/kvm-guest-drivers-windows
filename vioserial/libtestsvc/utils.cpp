...
static struct ErrEntry
{
  ...
  { 1064, "An exception occurred in the service when handling the control "
          "request." },
...
ChangeConfig ()
{
  ...
  res = ChangeServiceConfig (service, SERVICE_NO_CHANGE, SERVICE_NO_CHANGE,
