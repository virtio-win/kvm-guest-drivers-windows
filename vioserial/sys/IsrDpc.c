...
VOID
VIOSerialInterruptDpc (IN WDFINTERRUPT Interrupt,
...
VOID
VIOSerialQueuesInterruptDpc (IN WDFINTERRUPT Interrupt,
                             IN WDFOBJECT AssociatedObject)
{
  NTSTATUS status;
...
NTSTATUS
VIOSerialInterruptEnable (IN WDFINTERRUPT Interrupt,
...
NTSTATUS
VIOSerialInterruptDisable (IN WDFINTERRUPT Interrupt,
                           IN WDFDEVICE AssociatedDevice)
{
  UNREFERENCED_PARAMETER (AssociatedDevice);
