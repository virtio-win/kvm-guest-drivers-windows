...
.PARAMETER ConfigFile
    Path to the configuration file. Defaults to $env:ProgramFiles\virtio-win\viocfg.cfg
...
param(
    ...
    [string]$ConfigFile = "$env:ProgramFiles\virtio-win\viocfg.cfg"
)
...
function Read-ConfigFile {
    ...
    $adapters = [System.Collections.Generic.List[hashtable]]::new()
    $currentAdapter = @{}
