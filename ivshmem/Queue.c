...
VOID IVSHMEMEvtDeviceFileCreate(_In_ WDFDEVICE Device, _In_ WDFREQUEST Request, _In_ WDFFILEOBJECT FileObject)
{
                                   ...
                                   BOOLEAN ForKernel)
{
    ...
    __try
    {
        fileContext->shmemMap = MmMapLockedPagesSpecifyCache(DeviceContext->shmemMDL,
