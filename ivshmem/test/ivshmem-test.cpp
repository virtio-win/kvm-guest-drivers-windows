...
int __cdecl main()
{
    ...
    while (1)
    {
        ...
        if (SetupDiEnumDeviceInterfaces(deviceInfoSet, NULL, &GUID_DEVINTERFACE_IVSHMEM, 0, &deviceInterfaceData) ==
            FALSE)
        {
        ...
        if (map.vectors > 0)
        {
            ...
            if (!DeviceIoControl(devHandle,
                                 IOCTL_IVSHMEM_REGISTER_EVENT,
                                 &event,
                                 sizeof(IVSHMEM_EVENT),
                                 NULL,
                                 0,
                                 &ulReturnedLength,
                                 NULL))
